...
!function (e) {
    ...
    r = "undefined" != typeof window ? window : void 0, i = function i(r, _i) {
      ...
      function (e) {
        var t,
          ...
          P.apply(L = M.call(T.childNodes), T.childNodes), L[T.childNodes.length].nodeType;
        } catch (e) {
          ...
          var o, a, l, c, f, p, g, y, x, C;if ((t ? t.ownerDocument || t : T) !== h && d(t), t = t || h, r = r || [], !e || "string" != typeof e) return r;if (1 !== (c = t.nodeType) && 9 !== c) return [];if (m && !i) {
            if (o = ee.exec(e)) if (l = o[1]) {
              ...
              if (o[2]) return P.apply(r, t.getElementsByTagName(e)), r;if ((l = o[3]) && n.getElementsByClassName && t.getElementsByClassName) return P.apply(r, t.getElementsByClassName(l)), r;
            }if (n.qsa && (!v || !v.test(e))) {
              if (y = g = w, x = t, C = 9 === c && e, 1 === c && "object" !== t.nodeName.toLowerCase()) {
                ...
                return P.apply(r, x.querySelectorAll(C)), r;
              } catch (e) {} finally {
          ...
          var t,
            ...
            n += i(t);
              ...
              var t = N[e + " "];return t || (t = new RegExp("(^|" + R + ")" + e + "(" + R + "|$)")) && N(e, function (e) {
          ...
          return r && !r[w] && (r = be(r)), i && !i[w] && (i = be(i, o)), se(function (o, a, s, l) {
            ...
            } else v = xe(v === a ? v.splice(h, v.length) : v), i ? i(null, a, v, l) : P.apply(a, v);
          });
        }function we(e) {
            ...
            for (t || (t = s(e)), n = t.length; n--;) {
              ...
              var n = t.length > 0,
                ...
                var f,
                  ...
                  }P.apply(l, y), u && !_o && y.length > 0 && g + t.length > 1 && oe.uniqueSort(l);
                }return u && (C = w, c = x), v;
              };return n ? se(o) : o;
            }(o, i))).selector = e;
          }return a;
          ...
          var a,
            ...
            if ((u = h[0] = h[0].slice(0)).length > 2 && "ID" === (c = u[0]).type && n.getById && 9 === t.nodeType && m && r.relative[u[1].type]) {
              ...
              if ((p = r.find[f]) && (o = p(c.matches[0].replace(re, ie), te.test(u[0].type) && he(t.parentNode) || t))) {
                if (u.splice(a, 1), !(e = o.length && me(u))) return P.apply(i, o), i;break;
              }
            }
        ...
        if (m.isFunction(t)) return m.grep(e, function (e, r) {
          ...
          if (N.test(t)) return m.filter(t, e, n);t = m.filter(t, e);
        ...
        var n, r;if (!e) return this;if ("string" == typeof e) {
          if (!(n = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : D.exec(e)) || !n[1] && t) return !t || t.jquery ? (t || E).find(e) : this.constructor(t).find(e);if (n[1]) {
            if (t = t instanceof m ? t[0] : t, m.merge(this, m.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : g, !0)), k.test(n[1]) && m.isPlainObject(t)) for (n in t) {
        ...
        m.fn[e] = function (n, r) {
          ...
          H = /\S+/g,
          q = {};function P() {
        g.removeEventListener("DOMContentLoaded", P, !1), r.removeEventListener("load", P, !1), m.ready();
        ...
        return L || (L = m.Deferred(), "complete" === g.readyState ? setTimeout(m.ready) : (g.addEventListener("DOMContentLoaded", P, !1), r.addEventListener("load", P, !1))), L.promise(e);
      }, m.ready.promise();var M = m.access = function (e, t, n, r, i, o, a) {
        var s = 0,
            l = e.length,
        ...
        var r = !0,
          ...
          if (((i = ke(e, t, o)) < 0 || null == i) && (i = e.style[t]), Te.test(i)) return i;r = a && (h.boxSizingReliable() || i === e.style[t]), i = parseFloat(i) || 0;
        ...
        return new Fe.prototype.init(e, t, n, r, i);
          ...
          var i,
              o,
              a,
              s = m.camelCase(t);return t = m.cssProps[s] || (m.cssProps[s] = Le(e.style, s)), (a = m.cssHooks[t] || m.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = ke(e, t, r)), "normal" === i && t in Ae && (i = Ae[t]), "" === n || n ? (o = parseFloat(i), !0 === n || m.isNumeric(o) ? o || 0 : i) : i;
      ...
      }), m.cssHooks.marginRight = Ne(h.reliableMarginRight, function (e, t) {
        if (t) return m.swap(e, { display: "inline-block" }, ke, [e, "marginRight"]);
        ...
        try {
          ...
          Ct = {},
          kt = { 0: 200, 1223: 204 },
          Nt = m.ajaxSettings.xhr();r.ActiveXObject && m(r).on("unload", function () {
        for (var e in Ct) {
          Ct[e]();
        }
      }), h.cors = !!Nt && "withCredentials" in Nt, h.ajax = Nt = !!Nt, m.ajaxTransport(function (e) {
        var _t2;if (h.cors || Nt && !e.crossDomain) return { send: function send(n, r) {
            var i,
                o = e.xhr(),
              ...
              return function () {
                _t2 && (delete Ct[a], _t2 = o.onload = o.onerror = null, "abort" === e ? o.abort() : "error" === e ? r(o.status, o.statusText) : r(kt[o.status] || o.status, o.statusText, "string" == typeof o.responseText ? { text: o.responseText } : void 0, o.getAllResponseHeaders()));
              };
        ...
        if (!e || "string" != typeof e) return null;"boolean" == typeof t && (n = t, t = !1), t = t || g;var r = k.exec(e),
        ...
        m.cssHooks[t] = Ne(h.pixelPosition, function (e, n) {
          if (n) return n = ke(e, t), Te.test(n) ? m(e).position()[t] + "px" : n;
        });
      }), m.each({ Height: "height", Width: "width" }, function (e, t) {
        m.each({ padding: "inner" + e, content: t, "": "outer" + e }, function (n, r) {
          m.fn[r] = function (r, i) {
            var o = arguments.length && (n || "boolean" != typeof r),
                a = n || (!0 === r || !0 === i ? "margin" : "border");return M(this, function (t, n, r) {
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }), window.allowDrop = function (e) {
    ...
    r = t, e.dataTransfer.setData("text/html", t.innerHTML), i = t.id, k1class = t.className;
  }, window.drop = function (e, t) {
    if (e.preventDefault(), r != t) {
      o = t.id, r.id = o, t.id = i, k2class = t.className, r.className = k2class, t.className = k1class, r.innerHTML = t.innerHTML, t.innerHTML = e.dataTransfer.getData("text/html");var n = 0,
          a = 0,
  ...
  Object.defineProperty(t, "__esModule", { value: !0 }), t.showplans = t.showallplan = t.showplan = void 0;var r,
    ...
    var e = localStorage.getItem("myplan");e = JSON.parse(e);for (var t = "", n = "", r = 0; r < e.length; r++) {
      0 == e[r].done ? 1 == e[r].listatus ? (t += "<li id=" + e[r].id + ' class=liborder ondrop="drop(event,this)" ondragover="allowDrop(event)" draggable="true" ondragstart="drag(event, this)"><span><span></span><input type="checkbox" style="zoom:200%"/><span>', t += e[r].content, t += '</span></span><span class="del">X</span></li>') : (t += "<li id=" + e[r].id + '  ondrop="drop(event,this)" ondragover="allowDrop(event)" draggable="true" ondragstart="drag(event, this)"><span><span></span><input type="checkbox" style="zoom:200%"/><span>', t += e[r].content, t += '</span></span><span class="del">X</span></li>') : 1 == e[r].listatus ? (n += "<li id=" + e[r].id + ' class=liborder><span><span></span><input type="checkbox" checked="checked" style="zoom:200%"/><span>', n += e[r].content, n += '</span></span><span class="del">X</span></li>') : (n += "<li id=" + e[r].id + '><span><span></span><input type="checkbox" checked="checked" style="zoom:200%"/><span>', n += e[r].content, n += '</span></span><span class="del">X</span></li>');
    ...
    var e = 0;function t() {
      ...
      if (1 == (0, o.default)(this).prop("checked")) {
        var e = (0, o.default)(this).parent().parent().prop("id");(0, o.default)("#" + e).fadeOut(function () {
          ...
          if (t[n].id == e) {
            t[n].done = !0, t[n].listatus ? (0, o.default)("<li id=" + t[n].id + ' class=liborder><span><span></span><input type="checkbox"  style="zoom:200%" checked="checked"/><span>' + t[n].content + '</span></span><span class="del">X</span></li>').appendTo((0, o.default)(".todolist .list2>ul")) : (0, o.default)("<li id=" + t[n].id + '><span><span></span><input type="checkbox"  style="zoom:200%" checked="checked"/><span>' + t[n].content + '</span></span><span class="del">X</span></li>').appendTo((0, o.default)(".todolist .list2>ul"));var r = t[n];return t.splice(n, 1), t.push(r), localStorage.setItem("myplan", JSON.stringify(t)), void a.count();
          }
        }
      }
      ...
      if (0 == (0, o.default)(this).prop("checked")) {
        var e = (0, o.default)(this).parent().parent().prop("id");(0, o.default)("#" + e).remove();var t = localStorage.getItem("myplan");t = JSON.parse(t);for (var n = 0; n < t.length; n++) {
          if (t[n].id == e) {
            t[n].done = !1, t[n].listatus ? (0, o.default)("<li id=" + t[n].id + ' class=liborder  ondrop="drop(event,this)" ondragover="allowDrop(event)" draggable="true" ondragstart="drag(event, this)" ><span><span></span><input type="checkbox" style="zoom:200%" /><span>' + t[n].content + '</span></span><span class="del">X</span></li>').appendTo((0, o.default)(".todolist .list1>ul")) : (0, o.default)("<li id=" + t[n].id + '  ondrop="drop(event,this)" ondragover="allowDrop(event)" draggable="true" ondragstart="drag(event, this)" ><span><span></span><input type="checkbox" style="zoom:200%" /><span>' + t[n].content + '</span></span><span class="del">X</span></li>').appendTo((0, o.default)(".todolist .list1>ul"));var r = t[n];return t.splice(n, 1), t.push(r), localStorage.setItem("myplan", JSON.stringify(t)), void a.count();
          }
        }
      }
