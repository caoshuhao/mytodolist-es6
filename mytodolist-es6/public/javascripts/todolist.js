            ...
            if ($(this).prop("checked") == true) {
                ...
                for (var i = 0; i < data.length; i++) {
                    if (data[i].id == key) {
                        data[i].done = true;
                        if (data[i].listatus) {
                            $('<li id=' + data[i].id + ' ' + 'class=liborder><span><span></span><input type="checkbox"  style="zoom:200%" checked="checked"/><span>' + data[i].content + '</span></span><span class="del">X</span></li>').appendTo($(".todolist .list2>ul"));
                        } else {
            ...
            if ($(this).prop("checked") == false) {
                ...
                for (var i = 0; i < data.length; i++) {
                    if (data[i].id == key) {
                        data[i].done = false;
                        if (data[i].listatus) {
                            $('<li id=' + data[i].id + ' ' + 'class=liborder  ondrop="drop(event,this)" ondragover="allowDrop(event)" draggable="true" ondragstart="drag(event, this)" ><span><span></span><input type="checkbox" style="zoom:200%" /><span>' + data[i].content + '</span></span><span class="del">X</span></li>').appendTo($(".todolist .list1>ul"));
                        } else {
